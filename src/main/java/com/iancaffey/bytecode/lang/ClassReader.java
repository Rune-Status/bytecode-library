...
import com.iancaffey.bytecode.io.SourceHandler;
...
public class ClassReader extends BytecodeReader<ClassVisitor> {
    private final BytecodeHandler<ClassReader, ClassVisitor> handler = BytecodeHandler.of(new SourceHandler(), new FieldsHandler(), new MethodsHandler(), new AttributesHandler());
